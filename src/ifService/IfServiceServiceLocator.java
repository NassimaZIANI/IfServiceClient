...
public class IfServiceServiceLocator extends org.apache.axis.client.Service implements ifService.IfServiceService {
    ...
    private java.lang.String IfService_address = "http://localhost:8080/IfServiceServer/services/IfService";
    ...
    public ifService.IfService getIfService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            ifService.IfServiceSoapBindingStub _stub = new ifService.IfServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (ifService.IfService.class.isAssignableFrom(serviceEndpointInterface)) {
                ifService.IfServiceSoapBindingStub _stub = new ifService.IfServiceSoapBindingStub(new java.net.URL(IfService_address), this);
                _stub.setPortName(getIfServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ifService", "IfServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ifService", "IfService"));
        }
